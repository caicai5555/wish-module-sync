package com.foundation.test.canal;
...
public class ClientSample {
    ...
    public static void main(String args[]) {
        // 创建链接
        CanalConnector connector=CanalConnectors.newSingleConnector(new InetSocketAddress("192.168.1.55",11111), "example", "", "");
        //String zkServers, String destination, String username, String password
       // connector=newClusterConnector("192.168.1.55:2181","example","","");
