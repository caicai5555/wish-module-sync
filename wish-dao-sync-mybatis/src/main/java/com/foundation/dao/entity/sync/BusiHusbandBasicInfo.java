...
/**
 * @Title: BusiHusbandBasicInfo.java
 * @Package com.foundation.dao.entity.sync
 * @Description: 丈夫基本信息实体 busi_husband_basic_info
 * @author chunyangli(chunyangli@bioeh.com)
 * @date 2016/10/21 14:56 
 */
public class BusiHusbandBasicInfo extends BusiBaseEntity {
    private String husbandBasicInfoId;//主键
    ...
    private String certificateNumber;//证件类型
    ...
    private String hukouVillage;//户口所在
    ...
    public String getHusbandBasicInfoId() {
        return husbandBasicInfoId;
    }

    public void setHusbandBasicInfoId(String husbandBasicInfoId) {
        this.husbandBasicInfoId = husbandBasicInfoId == null ? null : husbandBasicInfoId.trim();
    }
