...
/**
 * @Title: BusiWifeHemoglobin
 * @Description: 15、	妻子血红蛋白分析表
 * @author SamWang(wangsammu@gmail.com)
 * @date 2016/10/21 10:51 
 */
 
public class BusiWifeHemoglobin extends BusiBaseEntity {
    private String wifeHemoglobinId;
    ...
    public String getWifeHemoglobinId() {
        return wifeHemoglobinId;
    }

    public void setWifeHemoglobinId(String wifeHemoglobinId) {
        this.wifeHemoglobinId = wifeHemoglobinId == null ? null : wifeHemoglobinId.trim();
    }
