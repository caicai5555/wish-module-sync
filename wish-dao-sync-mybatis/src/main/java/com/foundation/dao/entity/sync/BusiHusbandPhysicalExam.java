...
/**
 * @Title: BusiHusbandPhysicalExam.java
 * @Package com.foundation.dao.entity.sync
 * @Description: 丈夫体格检查实体 对应表： busi_husband_physical_exam
 * @author chunyangli(chunyangli@bioeh.com)
 * @date 2016/10/21 14:59
 */
public class BusiHusbandPhysicalExam extends BusiBaseEntity {
    private String husbandPhysicalExamId;//主键
    ...
    private Integer common;//常识（智力异常类型）

    private Integer judge;//判断（智力异常类型）

    private Integer memory;//记忆（智力异常类型）

    private Integer gene;//基因（智力异常类型）

    private Integer isFacial;//

    private String facialDetail;//

    private Integer isSpecialBody;//是否为特殊体态
    ...
    private Integer iscomplete;//完成状态
    ...
    public String getHusbandPhysicalExamId() {
        return husbandPhysicalExamId;
    }

    public void setHusbandPhysicalExamId(String husbandPhysicalExamId) {
        this.husbandPhysicalExamId = husbandPhysicalExamId == null ? null : husbandPhysicalExamId.trim();
    }
